...
export function IconGoogle({ size = 24, style, accessibilityLabel }: { size?: number; style?: any; accessibilityLabel?: string }) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 48 48" style={style} accessible accessibilityLabel={accessibilityLabel} accessibilityRole="image">
      <G>
...
export function IconAppleLogo({
  ...
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 384 512" style={style} accessible accessibilityLabel={accessibilityLabel} accessibilityRole="image">
      <Path
        fill={color}
