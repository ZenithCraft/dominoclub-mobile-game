...
-- CreateEnum
CREATE TYPE "FraudType" AS ENUM ('MULTI_ACCOUNT_DEVICE', 'MULTI_ACCOUNT_IP', 'SUSPICIOUS_GPS', 'GEOLOCATION_OUTSIDE_BRAZIL', 'RAPID_FIRE_BETS', 'BOT_PATTERN', 'COLLUSION_SUSPECTED', 'UNUSUAL_WIN_RATE', 'IMPOSSIBLE_MOVEMENT', 'INTEGRITY_FAIL', 'VELOCITY_ABUSE', 'DEVICE_LIMIT_EXCEEDED', 'ADMIN_ACTION');
...
-- AddForeignKey
ALTER TABLE "DeviceBind" ADD CONSTRAINT "DeviceBind_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserAnnouncementView" ADD CONSTRAINT "UserAnnouncementView_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserAnnouncementView" ADD CONSTRAINT "UserAnnouncementView_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Announcement"("id") ON DELETE CASCADE ON UPDATE CASCADE;
